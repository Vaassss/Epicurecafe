...
export default function App() {
  ...
  const handleLoginSuccess = useCallback((id: string, name: string, mobile: string, admin: boolean) => {
    setUserId(id);
    setUserName(name);
  ...
  const handleGoToBarista = useCallback(() => {
    setCurrentPage('barista');
  }, []);

  // Wrap each page in ErrorBoundary for isolated error handling
